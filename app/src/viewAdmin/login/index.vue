    ...
    <el-form class="card-box login-form" autoComplete="on" size="medium" :model="loginForm" :rules="loginRules" ref="loginForm" label-position="left">
      <div class="login_box">
        ...
        <el-form-item prop="user_name">
          <el-input name="user_name" type="text" @keyup.enter.native="handleLogin" v-model="loginForm.user_name" autoComplete="on" placeholder="用户名" maxlength="50"/>
...
<script>
  ...
  import { totSuc } from '@/utils/notice'
  import { getForget } from '@/apiAdmin/login'
